    ...
    render(){
        ...
        return(
            ...
            <div style={{textAlign: "left"}}>
                ...
                <h1 style={{backgroundColor: "lightgreen", margin: "0px"}}>Sample form</h1>
                ...
                <div style={{padding: "10px", backgroundColor: "lightsalmon"}}>
                    <h1 style={{backgroundColor: "lightseagreen", color: "wheat"}}>Entered information:</h1>
